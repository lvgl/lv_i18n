...
static const char * en_gb_singulars_indexed[] = {
...
#ifdef LV_I18N_OPTIMIZE
static const char * ru_ru_singulars_indexed[] = {
NULL, // 1="s_en_only"
...
static const lv_i18n_lang_t ru_ru_lang = {
    .locale_name = "ru-RU",
#ifdef LV_I18N_OPTIMIZE
    .singulars_indexed = ru_ru_singulars_indexed,
#else
...
const char * lv_i18n_get_text_by_idx(const char *msg_id, int msg_index)
{
    ...
    if(lang->singulars_indexed != NULL) {
        txt = lang->singulars_indexed[msg_index-1];
