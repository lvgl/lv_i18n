...
function lang_template(args, l, data) {
  ...
  return `
${!_.isEmpty(data[l].singular) ? lang_singular_template(args, l, data) : ''}
...
module.exports.getIDX = function (data) {
  let result = '#define LV_I18N_OPTIMIZE 1\n'
    + '#define LV_I18N_IDX_s(str) ' + getIDX2(data.singularKeys, 1) + '\n'
    + '#define LV_I18N_IDX_p(str) ' + getIDX2(data.pluralKeys, 1);
  return result;
};
